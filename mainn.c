...
int main() {
    ...
    do {
        ...
        printf("4. Calcular precio promedio de los productos\n");
        ...
        switch (opcion) {
            ...
            case 2:
                if (n > 0) mostrarProductos(nombres, precios, cantidades, n);
            ...
            case 4:
                if (n > 0)
                    printf("\nPrecio promedio ponderado: $%.2f\n", calcularPromedio(precios, cantidades, n));
                else
                    printf("\nNo hay productos registrados.\n");
                break;
            case 5:
